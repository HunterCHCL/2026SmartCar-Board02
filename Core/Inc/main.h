...
/* Private defines -----------------------------------------------------------*/
#define E2_CHA_Pin GPIO_PIN_0
#define E2_CHA_GPIO_Port GPIOA
#define E2_CHB_Pin GPIO_PIN_1
#define E2_CHB_GPIO_Port GPIOA
#define E3_CHA_Pin GPIO_PIN_6
#define E3_CHA_GPIO_Port GPIOA
#define E3_CHB_Pin GPIO_PIN_7
#define E3_CHB_GPIO_Port GPIOA
#define RR_IN2_Pin GPIO_PIN_12
#define RR_IN2_GPIO_Port GPIOB
#define RR_IN1_Pin GPIO_PIN_13
#define RR_IN1_GPIO_Port GPIOB
#define RL_IN2_Pin GPIO_PIN_14
#define RL_IN2_GPIO_Port GPIOB
#define RL_IN1_Pin GPIO_PIN_15
